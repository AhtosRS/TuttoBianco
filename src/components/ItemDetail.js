    ...
    return(
            ...
            <div className="itemDetail">
                ...
                <div className="detailContainer">
                    ...
                    {selectedQuantity>0?<button type="button" className="navbar-toggler btn btn-outline-dark " data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar" aria-controls="offcanvasNavbar" onClick={() => sendToCart(product)}>Confirmar: {selectedQuantity} un.</button>:<></>}
                </div>
            </div> 
